...
<nav class="navbar navbar-expand-lg navbar-dark bg-" style="background-color: #CA0403;">
        <li class="nav-link" data-bs-toggle="tooltip" data-bs-placement="top" title="Ferreteria Jotta-R" >
            <a href="inicio.php"><img style="margin-left: 450px;" src="img/logob2.png"  width="90" height="90"></img></a>
          </li>
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <div class="dropdown">
                <a class="nav-link"
                class="btn dropdown-toggle "  type="button" style="color: #fff;" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
...
<h3 style="text-align: center;" ><i class="fa-solid fa-layer-group fa-2xs" style="color: #f71d1d;"></i> &nbsp;Catalogo</h3>
<br>
  ...
  <img src="img/23.png" width="400" height="400" class="card-img" alt="Imagen articulos hogar">
...
<a href="plomeria.php">
<div class="card bg-dark text-white">
<img src="img/24.png" width="400" height="400" class="card-img" alt="Imagen articulos plomeria">
<div class="card-img-overlay">
<br><br><br><br><br><br><br><br><br><br>
    ...
    <div class="col-lg-4"> 
      <a href="pinturas.php">
      <div class="card bg-dark text-white">
  <img src="img/p.png" width="400" height="400" class="card-img" alt="Imagen articulos pinturas">
  <div class="card-img-overlay">
  <br><br><br><br><br><br><br><br><br><br>
...
<br>
  ...
  <div class="row" >
    <div class="col-lg-4">
      ...
      <div class="card bg-dark text-white">
  <img src="img/7.png" width="400" height="400" class="card-img" alt="Imagen articulos electricos">
  <div class="card-img-overlay">
  <br><br><br><br><br><br><br><br><br><br>
    ...
    <div class="col-lg-4">
      ...
      <div class="card bg-dark text-white">
  <img src="img/c.png" width="400" height="400" class="card-img" alt="Imagen articulos construcción">
  <div class="card-img-overlay">
   <br><br><br><br><br><br><br><br><br><br>
    ...
    <div class="col-lg-4"> 
      ...
      <div class="card bg-dark text-white">
  <img src="img/22.png" width="400" height="400"  class="card-img" alt="Imagen articulos bombillos">
  <div class="card-img-overlay">
  <br><br><br><br><br><br><br><br><br><br>
...
<br>
    ...
    <!-- Info - carrusel con ofertas de al por mayor y detalle / Pagina de instagram -->
...
<h3 style="text-align: center;"><i class="fa-solid fa-location-dot fa-xs" style="color: #f50f0f;"></i> Ubicación</h3>
<iframe style="text-align: center;" class="rounded mx-auto d-block" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3784.712139073683!2d-69.96746532590201!3d18.45137467128643!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8ea561f1912b43f7%3A0xa3448816e8d09726!2sFerreteria%20JOTTA-R!5e0!3m2!1ses-419!2sdo!4v1681958612367!5m2!1ses-419!2sdo" width="600" height="500" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
<hr>
...
<div class="container mt-5">
  ...
  <br>
     ...
     <!--Pie de pagina-->
        ...
        <img style="margin-left: 800px;" width="150" src="img/tarjeta.png" ></div>
        <li class="nav-link">
        ...
        <div class="container" style="color:#fff">
        <hr style="border: 1px solid white;"><img style="margin-right: 940px;" title="Ferreteria Jotta-R" width="40" src="img/logob2.png" > &copy; 2024 - <b> Ferreteria Jotta-R </b> - Todos los Derechos Reservados</a>
        </div>
        </nav>
      </div>
    </footer>
