...
<br>
      ...
      <form class="d-flex" id="form2" name="form2"  method="POST">
        ...
        <div class="container mt-4"> <div class="row d-flex justify-content-center"> 
          ...
          <div class="col-md-9"> <div class="card p-4 mt-3">  <a href="index.php" title="Refrescar" class="fa-solid fa-arrows-rotate " style=" background-color: transparent; color: #e20321;"></a> 
          <div class="d-flex justify-content-center px-5"> <div class="search"> <input type="text"  class="search-input" name="buscar" placeholder="¿Qué estás buscando?"> 
          
         
         <input type="submit" value="Buscar" class="search-icon" style="background-color: #e20321 ; " > <br> </div> </div>    </div> </div> 
        </form>
...
echo "
<center><a style='margin-left: 10px' class='aa' href='index.php?pagina=1'>" .'Anterior'. "</a>";

for($i=1; $i<=$total_paginas; $i++)

{
  echo"
  <a  style='margin-left: 10px' class='aa' href='index.php?pagina=".$i."'> ".$i."</a>  ";
}

echo"

 <a  class='aa'style='margin-left: 10px'  href='index.php?pagina=$total_paginas'>" .'Siguiente'."</a></center>
 ";
