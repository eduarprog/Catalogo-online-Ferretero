...
<?php                            //Paginacion
   ...
   echo "<br><center>";
   if ($pagina_actual > 1) {
   echo "<a title='Atrás' style='margin-left: 10px' class='aa' href='construccion.php?pagina=" . ($pagina_actual - 1) . "'>" . '<i class="fa-solid fa-chevron-up fa-rotate-270 fa-2xs" style="color: #CA0403;"></i>' . "</a>";
   }
   echo "<a title='Pagina actual' class='aa' style='margin-left: 10px'> " . $pagina_actual  . " / $empieza </a>";
    if ($pagina_actual < $total_paginas) {
   echo "<a title='Siguiente' class='aa' style='margin-left: 10px' href='construccion.php?pagina=" . ($pagina_actual + 1) . "'>" . '<i class="fa-solid fa-chevron-up fa-rotate-90 fa-2xs" style="color: #CA0403;"></i>' . "</a>";
   }
   echo "<br><br>
