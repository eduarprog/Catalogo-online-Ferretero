...
.card {
  ...
  max-height: 250px; /* Ajusta el alto máximo según tus necesidades */
  border-radius: 15px; /* Reduzco el valor de border-radius */
  padding: 10px; /* Reduzco el padding interno */
}
...
<form class="d-flex" id="form2" name="form2"  method="POST">
    <div class="container mt-4">
        <div class="row d-flex justify-content-center">
            <div class="col-md-9">
                <div class="1card p-2 mt-2  no-flotar-card">
                    <a href="productos.php" title="Actualizar" class="fa-solid fa-arrows-rotate " style=" background-color: transparent; color: #000;"></a>
...
<div class="container">
                    ...
                    <div class="col">
                        <div class="card shadow-sm" >
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text" style="color:green"> <b> <?php echo $data ['Descripcion'] ?></b></p>
   ...
   $por_pagina=  1;
    ...
    echo "<br>
    <center><a style='margin-left: 10px' class='aa' href='prueba1.php?pagina=1'>" . 'Anterior' . "</a>";

    for ($i = 1; $i <= $total_paginas; $i++) {
        echo "<a  style='margin-left: 10px' class='aa' href='prueba1.php?pagina=" . $i . "'> " . $i . "</a>  ";
    }

    echo "<a  class='aa' style='margin-left: 10px'  href='prueba1.php?pagina=$total_paginas'>" . 'Siguiente' . "</a></center>";
