        ...
        <div class="row d-flex justify-content-center">
            <div class="col-md-9">
                <div class="1card p-2 mt-2">
                    <a href="electricos.php" title="Actualizar" class="fa-solid fa-spin fa-arrows-rotate " style=" background-color: transparent; color: #fff;"></a>
...
<div class="container">
   ...
   $por_pagina=  1;
    ...
    echo "<br>
    <center><a style='margin-left: 10px' class='aa' href='electricos.php?pagina=1'>" . 'Anterior' . "</a>";

    for ($i = 1; $i <= $total_paginas; $i++) {
        echo "<a  style='margin-left: 10px' class='aa' href='electricos.php?pagina=" . $i . "'> " . $i . "</a>  ";
    }

    echo "<a  class='aa' style='margin-left: 10px'  href='electricos.php?pagina=$total_paginas'>" . 'Siguiente' . "</a></center>";
