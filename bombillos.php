...
<head>
    ...
    <title>Bombillos | Ferretería Jotta-R</title>
    <style>
body {
...
<nav class="navbar navbar-expand-lg navbar-dark bg-" style="background-color: #CA0403;">
        ...
        <li> <a class="dropdown-item" href="productos.php">  <i class="fa-solid fa-list" style="color: #e40c0c;"></i> 
          ...
          <li class="navbar-nav">
          <i class="fa-solid fa-lightbulb" style="color: #fbfcfe;"></i> &nbsp; &nbsp;
          <i class="fa-regular fa-lightbulb" style="color: #f5f5f5;"></i>&nbsp; &nbsp;
          <i class="fa-solid fa-car-battery" style="color: #ffffff;"></i>&nbsp; &nbsp;
          <i class="fa-solid fa-bolt-lightning"  style="color: #f5f5f5;"></i>
             </li>
    </nav>
</div>
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-md-9">
                <div class="1card p-2 mt-2">
                    <a href="bombillos.php" class="fa-solid fa-spin fa-arrows-rotate " style=" background-color: transparent; color: #fff;"></a>
...
if (!empty($_POST['buscar'])) {
    $buscar = $_POST['buscar'];
    $sql = "SELECT * FROM bombillos  WHERE Nombre LIKE '%$buscar%'";
} else {
  
  $sql="SELECT * FROM bombillos LIMIT $empieza,$por_pagina";
...
<?php                            //Paginacion
   ...
   echo "<br><center>";
   if ($pagina_actual > 1) {
   echo "<a title='Atrás' style='margin-left: 10px' class='aa' href='bombillos.php?pagina=" . ($pagina_actual - 1) . "'>" . '<i class="fa-solid fa-chevron-up fa-rotate-270 fa-2xs" style="color: #CA0403;"></i>' . "</a>";
   }
   echo "<a title='Pagina actual' class='aa' style='margin-left: 10px'> " . $pagina_actual  . " / $empieza </a>";
    if ($pagina_actual < $total_paginas) {
    echo "<a title='Siguiente' class='aa' style='margin-left: 10px' href='bombillos.php?pagina=" . ($pagina_actual + 1) . "'>" . '<i class="fa-solid fa-chevron-up fa-rotate-90 fa-2xs" style="color: #CA0403;"></i>' . "</a>";
   }
   echo "<br><br>
