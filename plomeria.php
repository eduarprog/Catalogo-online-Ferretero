...
<head>
    ...
    <title>Plomeria | Ferretería Jotta-R</title>
    <style>
...
<li class="nav-item">
          ...
          &nbsp; &nbsp;
          <i class="fa-solid fa-toilet" style="color: #f5f5f5;"></i>
            &nbsp; &nbsp;
            <i class="fa-solid fa-bath" style="color: #ffffff;"></i>
            &nbsp; &nbsp;
            <i class="fa-solid fa-shower" style="color: #f5f5f5;"></i>
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-md-9">
                <div class="1card p-2 mt-2">
                    <a href="plomeria.php" title="Actualizar" class="fa-solid fa-spin fa-arrows-rotate " style=" background-color: transparent; color: #fff;"></a>
...
<div class="container">
   ...
   $por_pagina=  1;
    ...
    if ($pagina_actual > 1) {
        echo "<a title='Atrás' style='margin-left: 10px' class='aa' href='plomeria.php?pagina=" . ($pagina_actual - 1) . "'>" . '<i class="fa-solid fa-chevron-up fa-rotate-270 fa-2xs" style="color: #CA0403;"></i>' . "</a>";
    }
    
    echo "<a title='Pagina actual' class='aa' style='margin-left: 10px'> " . $pagina_actual  . " / $empieza </a>";
    
    if ($pagina_actual < $total_paginas) {
        echo "<a title='Siguiente' class='aa' style='margin-left: 10px' href='plomeria.php?pagina=" . ($pagina_actual + 1) . "'>" . '<i class="fa-solid fa-chevron-up fa-rotate-90 fa-2xs" style="color: #CA0403;"></i>' . "</a>";
    }
