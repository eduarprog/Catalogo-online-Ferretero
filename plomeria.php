...
<div class="container">
   ...
   $por_pagina=  1;
    ...
    if ($pagina_actual > 1) {
        echo "<a style='margin-left: 10px' class='aa' href='plomeria.php?pagina=" . ($pagina_actual - 1) . "'>" . 'Atrás' . "</a>";
    }
    ...
    if ($pagina_actual < $total_paginas) {
        echo "<a class='aa' style='margin-left: 10px' href='plomeria.php?pagina=" . ($pagina_actual + 1) . "'>" . 'Siguiente' . "</a>";
    }
