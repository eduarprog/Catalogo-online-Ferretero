...
<main>
    ...
    <div class="card-body">
    <i class="fa-solid fa-palette" style="color: #e40c0c;"></i> &nbsp; 
      <center>
...
{
  echo"
  <a  style='margin-left: 10px' class='aa' href='pinturas.php?pagina=".$i."'> ".$i."</a>  ";
}

echo"

 <a  class='aa'style='margin-left: 10px'  href='pinturas.php?pagina=$total_paginas'>" .'Siguiente'."</a></center>
 ";
