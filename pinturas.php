...
<head>
    ...
    <title>Pinturas | Ferretería Jotta-R</title>
    <style>
...
<li class="nav-item">
          ...
          <li class="navbar-nav">
          <i class="fa-solid fa-paintbrush" style="color: #fbfcfe;"></i> 
          &nbsp; &nbsp;
          <i class="fa-solid fa-brush" style="color: #f5f5f5;"></i>
            &nbsp; &nbsp;
            <i class="fa-solid fa-spray-can" style="color: #ffffff;"></i>
            &nbsp; &nbsp;
            <i class="fa-solid fa-fill-drip" style="color: #f5f5f5;"></i>
...
if (!empty($_POST['buscar'])) {
    $buscar = $_POST['buscar'];
    $sql = "SELECT * FROM pintura  WHERE Nombre LIKE '%$buscar%'";
} else {
  
  $sql="SELECT * FROM pintura LIMIT $empieza,$por_pagina";
...
<div class="container">
   ...
   $por_pagina=  1;
    ...
    if ($pagina_actual > 1) {
        echo "<a title='Atrás' style='margin-left: 10px' class='aa' href='pinturas.php?pagina=" . ($pagina_actual - 1) . "'>" . '<i class="fa-solid fa-chevron-up fa-rotate-270 fa-2xs" style="color: #CA0403;"></i>' . "</a>";
    }
    
    echo "<a title='Pagina actual' class='aa' style='margin-left: 10px'> " . $pagina_actual  . " / $empieza </a>";
    
    if ($pagina_actual < $total_paginas) {
        echo "<a title='Siguiente class='aa' style='margin-left: 10px' href='pinturas.php?pagina=" . ($pagina_actual + 1) . "'>" . '<i class="fa-solid fa-chevron-up fa-rotate-90 fa-2xs" style="color: #CA0403;"></i>' . "</a>";
    }
